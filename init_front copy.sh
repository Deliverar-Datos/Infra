...
NODE_VERSION="22" # Versión LTS recomendada para producción
...
cert(){
   sleep 200 
   sudo certbot --nginx -d tableros.deliver.ar --email bautistafantauzzo@gmail.com --agree-tos --non-interactive --redirect
}
main() {
  check_prerequisites
  update_packages
